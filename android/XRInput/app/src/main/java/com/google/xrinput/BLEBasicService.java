...
public class BLEBasicService implements BLEService {
    ...
    protected BLEBasicService(@NotNull BluetoothPeripheralManager peripheralManager) {
        this.peripheralManager = Objects.requireNonNull(peripheralManager);
    }

    protected BluetoothGattDescriptor getClientCharacteristicConfigurationDescriptor() {
    ...
    protected boolean noCentralsConnected() {
